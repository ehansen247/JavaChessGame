...
public class Chess {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(!timer.toUpperCase().equals("NO") && !digitChecker(timer));
        if (!timer.toUpperCase().equals("NO")) {
     ...
     */
    private static boolean digitChecker(String str) {
